									...
									<c:forEach items="${pageInfo}" var="user">
										...
										<tr>
											...
											<td class="text-center">
												<button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/user/allrole.do?id='+${user.id}">添加角色</button>
											</td>
										</tr>
									</c:forEach>
								</tbody>
			...
			$("#del_button").click(function () {
				if(window.confirm("是否确认删除")){
					...
					$.ajax({
						...
						url : "${pageContext.request.contextPath}/user/del.do",
